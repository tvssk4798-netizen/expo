...
<EASFunctionDescription
  name="install_node_modules"
  exampleMode="Custom Build"
/>
...
<EASFunctionDescription
  name="posthog_upload_sourcemaps"
  exampleMode="Custom Build"
/>
